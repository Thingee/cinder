...
class API(base.Base):
    ...
    def delete(self, context, transfer_id):
        ...
        """
        policy.check_policy(context, 'delete_transfer')
    ...
    def get_all(self, context, filters={}):
        policy.check_policy(context, 'get_all_transfers')
    ...
    def create(self, context, volume_id, display_name):
        ...
        policy.check_policy(context, 'create_transfer')
    ...
    def accept(self, context, transfer_id, auth_key):
        ...
        # owned by the donor.
        policy.check_policy(context, 'accept_transfer')
